...
export default function Footer() {
  return (
<footer>
    <div class="py-4 text-black-400" style={{backgroundColor: '#f5f5f5'}}>
      <div class="container px-4 mx-auto">
      <div className="-mx-4 flex flex-wrap justify-between" style={{backgroundColor: '#f5f5f5'}}>
      <div class="px-4 my-4 w-full xl:w-1/5">
              ...
              <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="black" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400"><b>Phone:</b> 9080127902</a></li>
              <li><a href="#" class="hover:text-blue-400"><b>Whatsapp:</b> 990202892</a></li>
              <li><a href="#" class="hover:text-blue-400"><b>E-mail:</b> asdfi@gmail.com</a></li>
            </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-black-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
            ...
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-black-100 rounded-full hover:text-blue-400 hover:border-blue-400">
    ...
    <div class="py-4 text-black-100" style={{backgroundColor: '#f5f5f5'}}>
